...
def-env activate-virtualenv [] {
    ...
    let virtual-env = '/Users/bakdauletbolat/StudioProjects/defile_back/env'
    let bin = 'bin'
    let path-sep = ':'
...
alias deactivate = source '/Users/bakdauletbolat/StudioProjects/defile_back/env/bin/deactivate.nu'
